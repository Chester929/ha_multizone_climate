...
- **host**: Redis host address (default: 127.0.0.1 when mode is external)
- **port**: Redis port (default: 6379 when mode is external)
- **bundled_port**: Redis port for bundled mode (default: 6380)
