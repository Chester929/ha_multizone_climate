...
Then you will find all solutions and present them to the user before creating implementation plans.
You should also recommend the best solution with some reason described.
...
- Learning steps:
  ...
  - Home Assistant Learn:
    ...
    - Check and learn best practicies for Home Assistant Components
    - Check and learn Home Assistant integrations and automations
    - Check and learn Home Assistant addons
    - Check and learn Home Assistant notifications
...
Every time you shold give to user options what to do next.
Once you are requested to do changes you can create .md files and documentations describing:
- issue
- requests
- detaily described solution
- implementation plan
- architecture documentation (code, automats, flows)
- detailed bussines logic documentation with all scenarios
- critical tasks (if there are some)
- security requierements
- questions what need to be resolved before implementation ( when there are no questions, mark as IMPLEMENTATION READY)
