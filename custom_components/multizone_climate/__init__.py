...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    coordinator_interval = entry.data.get(
    ...
    try:
        ...
        _LOGGER.info(
            "Multizone Climate integration setup complete for entry %s", entry.entry_id
        )
...
async def async_unload_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    if unload_ok:
        ...
        _LOGGER.info(
            "Multizone Climate integration unloaded for entry %s", entry.entry_id
        )
